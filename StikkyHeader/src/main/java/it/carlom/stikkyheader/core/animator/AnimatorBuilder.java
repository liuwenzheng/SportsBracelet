...
public class AnimatorBuilder {
    ...
    public AnimatorBuilder applyRotationX(View viewToRotationX, float rotationX) {
        return applyRotationX(viewToRotationX, rotationX, null);
    }

    public AnimatorBuilder applyRotationX(View viewToRotationX, float rotationX, Interpolator interpolator) {
        if (viewToRotationX == null) {
            throw new IllegalArgumentException("You passed a null view");
        }

        float startRotationX = StikkyCompat.getRotationX(viewToRotationX);
        addAnimator(AnimatorBundle.create(AnimatorBundle.TypeAnimation.ROTATIONX, viewToRotationX, interpolator, startRotationX, rotationX));
        ...
        for (AnimatorBuilder.AnimatorBundle animatorBundle : mSetAnimatorBundles) {
            ...
            switch (animatorBundle.mTypeAnimation) {
                ...
                case PARALLAX:
                    ...
                    break;
                case ROTATIONX:
                    StikkyCompat.setRotationX(animatorBundle.mView, valueAnimation);
                    break;
    ...
    public static class AnimatorBundle {
        ...
        public enum TypeAnimation {
            SCALEX, SCALEY, SCALEXY, FADE, TRANSLATIONX, TRANSLATIONY, PARALLAX, ROTATIONX
        }
