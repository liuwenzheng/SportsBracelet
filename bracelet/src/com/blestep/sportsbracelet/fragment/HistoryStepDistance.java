...
public class HistoryStepDistance extends Fragment implements
    ...
    private TextView history_distance_daily, tv_history_distance_daily,
            tv_history_distance_sum, tv_history_distance_daily_unit, tv_history_distance_sum_unit;
    private View mView;
    ...
    private void initView() {
        ...
        mView.findViewById(R.id.btn_pre).setEnabled(false);
        mView.findViewById(R.id.btn_next).setEnabled(false);
        tv_history_distance_daily_unit = (TextView) mView
                .findViewById(R.id.tv_history_distance_daily_unit);
        tv_history_distance_sum_unit = (TextView) mView
                .findViewById(R.id.tv_history_distance_sum_unit);
        // 转换为英制
        SPUtiles.getInstance(getActivity());
        if (SPUtiles.getBooleanValue(BTConstants.SP_KEY_IS_BRITISH_UNIT, false)) {
            tv_history_distance_daily_unit.setText(getString(R.string.step_distance_unit_british));
            tv_history_distance_sum_unit.setText(getString(R.string.step_distance_unit_british));
        } else {
            tv_history_distance_daily_unit.setText(getString(R.string.step_distance_unit));
            tv_history_distance_sum_unit.setText(getString(R.string.step_distance_unit));
        }
    }
